...
def test_worker_settings_wired() -> None:
    ...
    assert names == {SYNC_JOB_NAME, DOWNLOAD_JOB_NAME, ANALYZE_JOB_NAME, SEND_ALERT_JOB_NAME}
...
@pytest.mark.parametrize(
    "job_name", [SYNC_JOB_NAME, DOWNLOAD_JOB_NAME, ANALYZE_JOB_NAME, SEND_ALERT_JOB_NAME]
)
